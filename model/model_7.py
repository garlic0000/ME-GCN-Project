...
class GCN(nn.Module):
    def __init__(self, nfeat, nhid, nout, mat_path, dropout=0.3, num_layers=2):  # 默认更深的网络
...
class AUwGCN(torch.nn.Module):
    def __init__(self, opt):
        ...
        # 增加GCN层数
        self.graph_embedding = torch.nn.Sequential(GCN(2, 32, 32, mat_path, num_layers=2))
