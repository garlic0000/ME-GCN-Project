...
def drop_edge(adj, drop_prob=0.2, epoch=0, max_epochs=100, min_drop_prob=0.03):
    """动态调整 DropEdge 概率
...
class GraphConvolution(nn.Module):
    ...
    def __init__(self, in_features, out_features, mat_path, bias=True, drop_prob=0.2, min_drop_prob=0.03):
