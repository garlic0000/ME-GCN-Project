...
def drop_edge(adj, drop_prob=0.5, epoch=0, max_epochs=100, min_drop_prob=0.01):
    """动态调整 DropEdge 概率
...
class GraphConvolution(nn.Module):
    ...
    def __init__(self, in_features, out_features, mat_path, bias=True, drop_prob=0.5, min_drop_prob=0.01):
...
class MultiHeadGraphAttentionLayer(nn.Module):
    ...
    def __init__(self, in_features, out_features, num_heads=4, dropout=0.6, alpha=0.2, drop_prob=0.5,
                 min_drop_prob=0.01):
