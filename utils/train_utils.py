import torch
from model.model_12 import GraphConvolution
from model.model_12 import GraphAttentionLayer, MultiHeadGraphAttentionLayer
...
def configure_optimizers(model, learning_rate, weight_decay):
    ...
    torch.nn.Linear, torch.nn.Conv1d, GraphConvolution, GraphAttentionLayer, MultiHeadGraphAttentionLayer, torch.nn.Conv2d)
